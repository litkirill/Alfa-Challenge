...
Итоговая метрика соревнования — WMAE, с неизвестными весовыми коэффициентами. В этом пункте представлен метод определения этих весов с использованием данных из лидерборда.
