...
Для каждой группы была рассчитана суммарная значимость путём сложения важностей её признаков, что позволяет оценить вклад каждой категории признаков в итоговую модель:
