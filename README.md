...
2. **Постановка задачи оптимизации**  
   Задача состоит в нахождении весов $w$, которые минимизируют невязку между предсказанными и целевыми значениями $WMAE$. Каждое уравнение системы выглядит так:  
